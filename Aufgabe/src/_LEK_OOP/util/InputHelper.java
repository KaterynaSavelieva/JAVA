...
public class InputHelper {
    ...
    public static int readInt2(Scanner scanner, String prompt, int min, int max) {
        while (true) {
...
// $            -> end of the string
    ...
    public static int readPositiveInt2(Scanner scanner, String prompt) {
        while (true) {
            System.out.print(prompt);
            String input = scanner.nextLine().trim();
